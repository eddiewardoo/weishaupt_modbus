...
SYS_BETRIEBSANZEIGE: list[StatusItem] = [
    StatusItem(number=0, text="undefiniert", translation_key="system_operationmode_undefined"),
    StatusItem(number=1, text="Relaistest", translation_key="system_operationmode_relaistest"),
    StatusItem(number=2, text="Notaus", translation_key="system_operationmode_emergencystop"),
    StatusItem(number=3, text="Diagnose", translation_key="system_operationmode_diagnosis"),
    StatusItem(number=4, text="Handbetrieb", translation_key="system_operationmode_manual"),
    StatusItem(number=5, text="Handbetrieb Heizen", translation_key="system_operationmode_manualheating"),
    StatusItem(number=6, text="Handbetrieb Kühlen", translation_key="system_operationmode_manualcooling"),
    StatusItem(number=7, text="Manueller Abtaubetrieb", translation_key="system_operationmode_manualdefrost"),
    StatusItem(number=8, text="Abtauen", translation_key="system_operationmode_defrost"),
    StatusItem(number=9, text="2. WEZ", translation_key="system_operationmode_manual2ndheatsource"),
    StatusItem(number=10, text="EVU_SPERRE", translation_key="system_operationmode_sgtariff"),
    StatusItem(number=11, text="SG Tarif", translation_key="system_operationmode_sgtariff"),
    StatusItem(number=12, text="SG Maximal", translation_key="system_operationmode_sgmax"),
    StatusItem(number=13, text="Tarifladung", translation_key="system_operationmode_tariffload"),
    StatusItem(number=14, text="Erhöhter Betrieb", translation_key="system_operationmode_elevatedoperation"),
    StatusItem(number=15, text="Standzeit", translation_key="system_operationmode_standbytime"),
    StatusItem(number=16, text="Standby", translation_key="system_operationmode_standby"),
    StatusItem(number=17, text="Spülen", translation_key="system_operationmode_rinse"),
    StatusItem(number=18, text="Frostschutz", translation_key="system_operationmode_frosprotection"),
    StatusItem(number=19, text="Heizbetrieb", translation_key="system_operationmode_heating"),
    StatusItem(number=20, text="Warmwasserbetrieb", translation_key="system_operationmode_hotwater"),
    StatusItem(number=21, text="Legionellenschutz", translation_key="system_operationmode_legionellaprotection"),
    StatusItem(number=22, text="Umschaltung HZ KU", translation_key="system_operationmode_switchheatingcooling"),
    StatusItem(number=23, text="Kühlbetrieb", translation_key="system_operationmode_cooling"),
    StatusItem(number=24, text="Passive Kühlung", translation_key="system_operationmode_passivecooling"),
    StatusItem(number=25, text="Sommerbetrieb", translation_key="system_operationmode_summer"),
    StatusItem(number=26, text="Schwimmbadbetrieb", translation_key="system_operationmode_swimmingpool"),
    StatusItem(number=27, text="Urlaub", translation_key="system_operationmode_vacation"),
    StatusItem(number=28, text="Estrichprogramm", translation_key="system_operationmode_screedprogram"),
    StatusItem(number=29, text="Gesperrt", translation_key="system_operationmode_locked"),
    StatusItem(number=30, text="Sperre AT", translation_key="system_operationmode_lockedat"),
    StatusItem(number=31, text="Sperre Sommer", translation_key="system_operationmode_lockedsummer"),
    StatusItem(number=32, text="Sperre Winter", translation_key="system_operationmode_lockedwinter"),
    StatusItem(number=33, text="Einsatzgrenze", translation_key="system_operationmode_applicationlimit"),
    StatusItem(number=34, text="HK Sperre", translation_key="system_operationmode_lockedcv"),
    StatusItem(number=35, text="Absenkbetrieb", translation_key="system_operationmode_lowering"),
    StatusItem(number=36, text="Vorlauf regenerativ", translation_key="system_operationmode_regenerativeflow"),
    StatusItem(number=43, text="Ölrückführung", translation_key="system_operationmode_oilrecirculation"),
]

SYS_BETRIEBSART: list[StatusItem] = [
    StatusItem(number=0, text="Automatik", translation_key="sys_operationmode_automatic"),
    ...
    StatusItem(number=5, text="2.WEZ", translation_key="sys_operationmode_2ndheatsource"),
]

HP_BETRIEB: list[StatusItem] = [
    StatusItem(number=0, text="Undefiniert", translation_key="heatpump_operationmode_undefined"),
    StatusItem(number=1, text="Relaistest", translation_key="heatpump_operationmode_relaistest"),
    StatusItem(number=2, text="Notaus", translation_key="heatpump_operationmode_emergencystop"),
    StatusItem(number=3, text="Diagnose", translation_key="heatpump_operationmode_diagnosis"),
    StatusItem(number=4, text="Handbetrieb", translation_key="heatpump_operationmode_manual"),
    StatusItem(number=5, text="Handbetrieb Heizen", translation_key="heatpump_operationmode_manualheating"),
    StatusItem(number=6, text="Handbetrieb Kühlen", translation_key="heatpump_operationmode_manualcooling"),
    StatusItem(number=7, text="Manueller Abtaubetrieb", translation_key="heatpump_operationmode_manualdefrost"),
    StatusItem(number=8, text="Abtauen", translation_key="heatpump_operationmode_defrost"),
    StatusItem(number=9, text="WEZ2", translation_key="heatpump_operationmode_manual2ndheatsource"),
    StatusItem(number=10, text="EVU_SPERRE", translation_key="heatpump_operationmode_evu"),
    StatusItem(number=11, text="SG Tarif", translation_key="heatpump_operationmode_sgtariff"),
    StatusItem(number=12, text="SG Maximal", translation_key="heatpump_operationmode_sgmax"),
    StatusItem(number=13, text="Tarifladung", translation_key="heatpump_operationmode_tariffload"),
    StatusItem(number=14, text="Erhöhter Betrieb", translation_key="heatpump_operationmode_elevatedoperation"),
    StatusItem(number=15, text="Standzeit", translation_key="heatpump_operationmode_standbytime"),
    StatusItem(number=16, text="Standbybetrieb", translation_key="heatpump_operationmode_standby"),
    StatusItem(number=17, text="Spülbetrieb", translation_key="heatpump_operationmode_rinse"),
    StatusItem(number=18, text="Frostschutz", translation_key="heatpump_operationmode_frosprotection"),
    StatusItem(number=19, text="Heizbetrieb", translation_key="heatpump_operationmode_heating"),
    StatusItem(number=20, text="Warmwasserbetrieb", translation_key="heatpump_operationmode_hotwater"),
    StatusItem(number=21, text="Legionellenschutz", translation_key="heatpump_operationmode_legionellaprotection"),
    StatusItem(number=22, text="Umschaltung HZ KU", translation_key="heatpump_operationmode_switchheatingcooling"),
    StatusItem(number=23, text="Kühlbetrieb", translation_key="heatpump_operationmode_cooling"),
    StatusItem(number=24, text="Passive Kühlung", translation_key="heatpump_operationmode_passivecooling"),
    StatusItem(number=25, text="Sommerbetrieb", translation_key="heatpump_operationmode_summer"),
    StatusItem(number=26, text="Schwimmbad", translation_key="heatpump_operationmode_swimmingpool"),
    StatusItem(number=27, text="Urlaub", translation_key="heatpump_operationmode_vacation"),
    StatusItem(number=28, text="Estrich", translation_key="heatpump_operationmode_screedprogram"),
    StatusItem(number=29, text="Gesperrt", translation_key="heatpump_operationmode_locked"),
    StatusItem(number=30, text="Sperre AT", translation_key="heatpump_operationmode_lockedat"),
    StatusItem(number=31, text="Sperre Sommer", translation_key="heatpump_operationmode_lockedsummer"),
    StatusItem(number=32, text="Sperre Winter", translation_key="heatpump_operationmode_lockedwinter"),
    StatusItem(number=33, text="Einsatzgrenze", translation_key="heatpump_operationmode_applicationlimit"),
    StatusItem(number=34, text="HK Sperre", translation_key="heatpump_operationmode_lockedcv"),
    StatusItem(number=35, text="Absenk", translation_key="heatpump_operationmode_lowering"),
    StatusItem(number=43, text="Ölrückführung", translation_key="heatpump_operationmode_oilrecirculation"),
]
...
HZ_BETRIEBSART: list[StatusItem] = [
    StatusItem(number=0, text="Automatik", translation_key="hz_operationmode_automatic"),
    ...
    StatusItem(number=3, text="Absenkbetrieb", translation_key="hz_operationmode_lowering"),
...
MODBUS_SYS_ITEMS: list[ModbusItem] = [
    ...
    ModbusItem( address=40001,  name="Systembetriebsart", mformat=FORMATS.STATUS, mtype=TYPES.SELECT, device=DEVICES.SYS, resultlist=SYS_BETRIEBSART, translation_key="sys_operationmode"),
] # noqa: E501
...
MODBUS_ST_ITEMS: list[ModbusItem] = [
    ...
    ModbusItem( address=36102, name="Gesamt Energie gestern", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.ST, resultlist=RANGE_ENERGY, translation_key="ges_energie_yesterday"),
    ...
    ModbusItem( address=36601, name="Gesamt Energie II heute", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.ST, resultlist=RANGE_ENERGY, translation_key="ges_energie_today"),
    ModbusItem( address=36602, name="Gesamt Energie II gestern", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.ST, resultlist=RANGE_ENERGY, translation_key="ges_energie_2_yesterday"),
    ...
    ModbusItem( address=36604, name="Gesamt Energie II Jahr", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.ST, resultlist=RANGE_ENERGY, translation_key="ges_energie_year"),
